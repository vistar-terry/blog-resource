...
- 深度学习
- 计算机视觉
date: 2020-08-01 21:02:36
math: true
---



![PointNet++](img/article/202008/20200330183554388.jpg)

### 一、概览

[论文地址：https://arxiv.org/pdf/1706.02413](https://arxiv.org/pdf/1706.02413)

[代码下载：https://github.com/charlesq34/pointnet2](https://github.com/charlesq34/pointnet2)

**论文框架：**

![论文框架](img/article/202008/20200330183554389.png)
...
![点云的分层分组结构](img/article/202008/20200330183554390.jpeg)
...
![(a) Multi-scale grouping (MSG); (b) Multiresolution grouping (MRG)](img/article/202008/20200331213508767.jpg)
...
对于所有实验，我们使用学习率为 $0.001$ 的 [ADAM](https://arxiv.org/abs/1412.6980) 优化器进行训练。对于数据增强，我们使用随机缩放对象、扰动对象位置和点样本位置的方法。我们还遵循[Volumetric and multi-view cnns for object
...
![](img/article/202008/20200331223032373.jpg)
...
![](img/article/202008/20200330183554391.jpeg)
...
![左：随机剔除处理的点云；右：密度自适应策略在处理非均匀密度的对比](img/article/202008/20200330183554392.jpeg)
...
![Scannet标注准确率](img/article/202008/20200331231406985.jpg)

下图可见，PointNet 正确捕捉房间的总体布局，但找不到家具。相比之下，除了房间布局之外，我们的方法在分割对象方面要好得多。

![Scannet标注结果](img/article/202008/20200331231349979.jpg)
...
![非刚性形状分类示例](img/article/202008/20200401121257288.jpg)
...
![SHREC15非刚性形状分类](img/article/202008/20200401183458986.jpg)
...
![从第一层核函数中学习到的3D点云模式](img/article/202008/20200401185519380.jpg)
